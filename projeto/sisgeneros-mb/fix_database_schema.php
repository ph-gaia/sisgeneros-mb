        ...
        try {
            ...
            $this->connectDatabase()->exec(
                ""
                    ...
                    . " CREATE TABLE IF NOT EXISTS `sisgeneros`.`invoices_has_requests` ( "
                    . "      `invoices_id` INT(11) NOT NULL, "
                    . "      `requests_id` INT(11) NOT NULL, "
                    . "  PRIMARY KEY (`invoices_id`, `requests_id`), "
                    . "      INDEX `fk_invoices_has_requests_requests_id` (`requests_id` ASC), "
                    . "      INDEX `fk_invoices_has_requests_invoices_id` (`invoices_id` ASC), "
                    . "  CONSTRAINT `fk_invoices_has_requests_invoices` "
                    . "      FOREIGN KEY (`invoices_id`) "
                    . "      REFERENCES `sisgeneros`.`invoices` (`id`) "
                    . "      ON DELETE NO ACTION "
                    . "      ON UPDATE NO ACTION, "
                    . "  CONSTRAINT `fk_invoices_has_requests_requests` "
                    ...
                    . " CREATE TABLE IF NOT EXISTS `sisgeneros`.`historic_invoices` ( "
                    . "      `id` INT(11) NOT NULL AUTO_INCREMENT, "
                    . "      `invoices_id` INT(11) NOT NULL, "
                    ...
                    . "      `created_at` DATETIME NOT NULL, "
                    . " PRIMARY KEY (`id`), "
                    . "      INDEX `fk_historic_invoices_invoices_id` (`invoices_id` ASC), "
                    . "      INDEX `fk_historic_invoices_users_id` (`users_id` ASC), "
                    . "  CONSTRAINT `fk_historic_invoices_invoices` "
                    . "      FOREIGN KEY (`invoices_id`) "
                    . "      REFERENCES `sisgeneros`.`invoices` (`id`) "
                    . "      ON DELETE NO ACTION "
                    . "      ON UPDATE NO ACTION, "
                    . "  CONSTRAINT `fk_historic_invoices_users` "
